    ...
    function saveTasks(){
        ...
        //"tasks" anahtarını kullanarak yerel depolamaya JSON formatına dönüştürülmüş tasks dizisini ekler. 
    ...
    function toggleTask(event){
        ...
        //event.target.nextElementSibling->sonraki kardeşini öğesine erişmesini sağlar.
        const text = event.target.nextElementSibling;
        text.style.textDecoration = event.target.checkhed?'line-through': 'none';
        saveTasks();
    }
    ...
    function editTask(event){
        //const textSpan = event.target.previousElementSibling->önceki kardeşi elementini temsil eden özelliktir.
